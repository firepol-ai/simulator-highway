      ...
      <div class="main-column">
        ...
        <section class="arcade-panel panel" aria-label="Arcade options">
          ...
          <div class="arcade-options">
            ...
            <label class="arcade-option"><span><strong>Horns & flashing lights</strong><small>Faster drivers flash first, then honk. Some ordinary drivers yield after flashes; others wait for the horn.</small></span><span class="toggle-label"><input id="arcade-signals" type="checkbox" aria-label="Horns and flashing lights" /><span class="toggle"></span></span></label>
