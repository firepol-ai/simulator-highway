      ...
      <div class="main-column">
        ...
        <section class="arcade-panel panel" aria-label="Arcade options">
          ...
          <div class="arcade-options">
            <label class="arcade-option"><span><strong>Impatient right-side passing</strong><small>Faster drivers pass on either side when held up, then return left after a right-side pass.</small></span><span class="toggle-label"><input id="arcade-undertaking" type="checkbox" aria-label="Impatient right-side passing" /><span class="toggle"></span></span></label>
            <label class="arcade-option"><span><strong>Horns & flashing lights</strong><small>Faster drivers signal in the left lane. Some ordinary drivers move right to let them pass.</small></span><span class="toggle-label"><input id="arcade-signals" type="checkbox" aria-label="Horns and flashing lights" /><span class="toggle"></span></span></label>
